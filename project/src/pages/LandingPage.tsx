        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-medium text-primary-800 text-center mb-2">Stor personalpool</h3>
              <p className="text-primary-700 text-center">
                Få omedelbar tillgång till ett brett nätverk av verifierade farmaceuter, egenvårdsrådgivare och säljare över hela Sverige.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-primary-100 text-primary-600 mb-4 mx-auto">
              ...
              <h3 className="text-lg font-medium text-primary-800 text-center mb-2">Komplett Personalhantering & Schemaläggning</h3>
              <p className="text-primary-700 text-center">
                Hantera både fast anställda och extrapersonal i samma system med integrerad schemaläggning och fyll bemanningsluckor snabbt vid behov.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-primary-100 text-primary-600 mb-4 mx-auto">
