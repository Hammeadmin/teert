...
const faqData = {
  ...
  employers: [
    ...
    { q: "Hur fungerar betalning och fakturering?", a: "Du betalar en fast månadsavgift enligt din valda prisplan. Ersättning till personalen hanteras smidigt och säkert direkt via plattformen." },
