  ...
  return (
    <div className="bg-brandBeige min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Back button (Kept from original) */}
        <div className="mb-8">
        ...
        <section id="for-employers" className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Plan 1: Standard (Now with the simple, non-highlighted style) */}
            ...
            {/* Plan 2: Enterprise (Now with the premium, highlighted style) */}
          ...
          <div className="mt-12 bg-primary-50 rounded-lg p-6 max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              <div><h4 className="font-medium text-gray-900">Ingår alla funktioner i Standard-planen?</h4><p className="text-gray-700 text-sm mt-1">Ja, Standard-planen ger dig full tillgång till alla plattformens kärnfunktioner, inklusive obegränsade pass, schemaläggning och lönehantering för ett apotek.</p></div>
              <div><h4 className="font-medium text-gray-900">Vem är Företagsplanen för?</h4><p className="text-gray-700 text-sm mt-1">Vår Företagsplan är skräddarsydd för apotekskedjor, konsultbolag eller organisationer som hanterar bemanning för flera apotek. Vi erbjuder volymrabatter och centraliserade verktyg för att förenkla administrationen.</p></div>
              <div><h4 className="font-medium text-gray-900">Finns det någon bindningstid?</h4><p className="text-gray-700 text-sm mt-1">Nej, vårt standardabonnemang löper månadsvis och du kan avsluta när du vill. För företagsplanen skräddarsyr vi ett avtal som passar era behov.</p></div>
            </div>
          </div>
        </section>

        {/* For Professionals Section (Kept from original) */}
        ...
        {/* All Plans Section (Kept from original) */}
        ...
        {/* Contact Section (Kept from original) */}
