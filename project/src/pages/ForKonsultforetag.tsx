        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div className="order-2 lg:order-1 mt-10 lg:mt-0">
              <img 
                src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?q=80&w=2940&auto=format&fit=crop" 
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className="mt-8 space-y-5">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Juridiskt Bindande</h4>
                    <p className="text-gray-600">Säkerställ era avtal med e-signering som är juridiskt bindande enligt svensk lagstiftning.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 flex-shrink-0 mt-1" />
